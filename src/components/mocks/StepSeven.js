...
const StepSeven = ({ProposalStep, handleIncrementClick}) => {
 ...
 The designated representatives or any registered elector who is not satisfied with the abstract prepared by the Legislative Council Staff may file a motion for a rehearing with the Secretary of State within seven days after the titles and submission clause for the initiative petition are set on the grounds that:  an estimate included in the abstract is incorrect; the abstract is misleading or prejudicial; or the abstract does not comply with statutory requirements.
      </p>
